...
def get_embedding(code_chunk: str, model: Optional[SentenceTransformer] = None) -> Optional[np.ndarray]:
    """
...
if __name__ == "__main__":
    ...
    if transformer_model:
        print(f"Model '{test_model_name}' initialized. Embedding dimension: {transformer_model.get_sentence_embedding_dimension()}")
